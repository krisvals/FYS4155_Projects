...
FFNN1 = FFNN(dimensions = [n_input_nodes,n_hidden_nodes,n_output_nodes],hidden_func = RELU) #creates an object of the neural network
...
for i, etaa in enumerate(eta_vals):
    for j, lmbd in enumerate(lmbd_vals): # starts a loop to test variables.
        ...
        FFNN1.fit(X_train,y_train, Adagrad(eta = (etaa)), epochs = 1000, lam = lmbd)
...
sns.heatmap(train_accuracy, annot=True, ax=ax, cmap="viridis", xticklabels=lmbd_vals, yticklabels=eta_vals, fmt=".1f",  annot_kws={"size": fontsize},  vmin=0, vmax=100)
ax.set_title("Training Accuracy Own Code [%]", fontsize=fontsize)
ax.set_ylabel("Learning Rate", fontsize=fontsize)
ax.set_xlabel("Regularization", fontsize=fontsize)
plt.tick_params(axis='both', labelsize=fontsize)
plt.savefig('C:/Users/IFE12739/FYS-STK 4155/C_own_RegLR_Train.pdf', format='pdf', bbox_inches="tight")
plt.show()

fig, ax = plt.subplots(figsize = (6, 6))
sns.heatmap(test_accuracy, annot=True, ax=ax, cmap="viridis", xticklabels=lmbd_vals, yticklabels=eta_vals,  annot_kws={"size": fontsize}, fmt=".1f",  vmin=0, vmax=100)
ax.set_title("Test Accuracy Own Code [%]", fontsize=fontsize)
ax.set_ylabel("Learning Rate", fontsize=fontsize)
ax.set_xlabel("Regularization", fontsize=fontsize)
plt.tick_params(axis='both', labelsize=fontsize)
plt.savefig('C:/Users/IFE12739/FYS-STK 4155/C_own_RegLR_Test.pdf', format='pdf', bbox_inches="tight")
plt.show()